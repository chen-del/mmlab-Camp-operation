...
log_level = 'INFO'
load_from = './work_dirs/rtmdet_tiny_balloon/best_coco_bbox_mAP_epoch_40.pth'
resume = False
train_cfg = dict(
...
data_root = '/home/hanhan/cc_wrod/develop/mmlab/mmdetection/datasets/Balloon/balloon/'
backend_args = None
train_pipeline = [
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root=
        '/home/hanhan/cc_wrod/develop/mmlab/mmdetection/datasets/Balloon/balloon/',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=
    '/home/hanhan/cc_wrod/develop/mmlab/mmdetection/datasets/Balloon/balloon/annotation_coco_val.json',
    metric='bbox',
    format_only=False,
    backend_args=None,
...
num_epochs_stage2 = 5
launcher = 'none'
work_dir = './work_dirs/rtmdet_tiny_balloon'
